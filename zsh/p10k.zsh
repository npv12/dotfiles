...
() {
  ...
  typeset -g POWERLEVEL9K_RULER_FOREGROUND=248

  # Filler between left and right prompt on thhost first prompt line. You can set it to '·' or '─'
  ...
  # typeset -g POWERLEVEL9K_HOST_ROOT_FOREGROUND=9
  # Context color in SSH without privileges.
  typeset -g POWERLEVEL9K_CONTEXT_{ROOT,REMOTE,REMOTE_SUDO}_FOREGROUND=9
  ...
  # typeset -g POWERLEVEL9K_CONTEXT_TEMPLATE='%F{105}%n@%F{123}%m%K'
  typeset -g POWERLEVEL9K_CONTEXT_TEMPLATE=''
  # Context format when in SSH without privileges: user@hostname.
  typeset -g POWERLEVEL9K_CONTEXT_{REMOTE,REMOTE_SUDO}_TEMPLATE=' %F{203}%n@%F{221}%m%K'
