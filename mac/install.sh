...
brew install bat bottom micro tmux ripgrep fd git-delta eza duf gdu zen mise gpg maccy pass zoxide colima \
...
echo "Pi is not installed. Please install it manually"
