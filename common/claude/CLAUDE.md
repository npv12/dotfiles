...
- **Notion**: When any link is using notion, use notion MCP. when working on a notion task, check its status, update to inprogress. Once done. update it to In review
