# Generated by Powerlevel10k configuration wizard on 2022-12-20 at 07:01 IST.
...
# 1 line, compact, many icons, concise, instant_prompt=auto-quiet.
...
() {
  ...
  typeset -g POWERLEVEL9K_RIGHT_PROMPT_ELEMENTS=(
    ...
    # nordvpn               # nordvpn connection status, linux only (https://nordvpn.com/), NEVER ENABLE. IT IS BROKEN
  ...
  typeset -g POWERLEVEL9K_{LEFT,RIGHT}_LEFT_WHITESPACE='%S%F{#1E1E2E}\uE0B6%s'
  typeset -g POWERLEVEL9K_{LEFT,RIGHT}_RIGHT_WHITESPACE='%S%F{#1E1E2E}\uE0B4%s'
  ...
  typeset -g POWERLEVEL9K_PROMPT_CHAR_OK_{VIINS,VICMD,VIVIS,VIOWR}_BACKGROUND="green"
  # Red prompt symbol if the last command failed.
  typeset -g POWERLEVEL9K_PROMPT_CHAR_ERROR_{VIINS,VICMD,VIVIS,VIOWR}_FOREGROUND=0
  typeset -g POWERLEVEL9K_PROMPT_CHAR_ERROR_{VIINS,VICMD,VIVIS,VIOWR}_BACKGROUND="red"
  # Default prompt symbol.
  typeset -g POWERLEVEL9K_PROMPT_CHAR_OK_VIINS_CONTENT_EXPANSION='%B󱜚%B'
  # Default prompt symbol.
  typeset -g POWERLEVEL9K_PROMPT_CHAR_ERROR_VIINS_CONTENT_EXPANSION='%B󱚢%B'
  ...
  typeset -g POWERLEVEL9K_HOME_ICON='%B %B'
  typeset -g POWERLEVEL9K_HOME_SUB_ICON='%B %B'
  typeset -g POWERLEVEL9K_FOLDER_ICON='%B %B'
  ...
  typeset -g POWERLEVEL9K_VCS_MODIFIED_BACKGROUND=181
  typeset -g POWERLEVEL9K_VCS_UNTRACKED_BACKGROUND=123
  typeset -g POWERLEVEL9K_VCS_CONFLICTED_BACKGROUND=214
  typeset -g POWERLEVEL9K_VCS_LOADING_BACKGROUND=195
  ...
  typeset -g POWERLEVEL9K_ASDF_JAVA_BACKGROUND=3
  ...
  typeset -g POWERLEVEL9K_ASDF_ERLANG_BACKGROUND=2
  ...
  typeset -g POWERLEVEL9K_MIDNIGHT_COMMANDER_BACKGROUND=3
  # Custom icon.
  ...
  function p10k-on-pre-prompt()  {
      p10k display '1/right/time'=hide '1/right/status'=show '1/right/mise'=show '1/left/vcs'=show '1/left/prompt_char'=hide '1/left/dir'=show '1/right/command_execution_time'=show
  }
  function p10k-on-post-prompt() {
      p10k display '1/right/time'=show '1/right/status'=hide '1/right/mise'=hide '1/left/vcs'=hide '1/left/prompt_char'=show '1/left/dir'=hide '1/right/command_execution_time'=hide
  }
